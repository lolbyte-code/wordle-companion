...
const updateExtension = () => {
  ...
  let words = [...document.querySelector("#wordle-app-game").querySelector("div:not(.pz-offline-ticker)").querySelector("div").childNodes].map(e => e.childNodes).map(e => [...e].map(e => e.querySelector("div").innerHTML).join(""))
  ...
  let evaluations = [...document.querySelector("#wordle-app-game").querySelector("div:not(.pz-offline-ticker)").querySelector("div").childNodes].map(n => n.childNodes).map(e => [...e].map(e => e.querySelector("div").getAttribute("data-state")))
